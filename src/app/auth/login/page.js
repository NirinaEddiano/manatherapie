                ...
                >
                    ...
                    <motion.div initial="hidden" animate="visible" variants={{ visible: { transition: { staggerChildren: 0.1 }} }}>
                        ...
                        <motion.form variants={{ hidden: { opacity: 0, y: 10 }, visible: { opacity: 1, y: 0 }}} className="space-y-4">
                            ...
                            <div className="text-right"><Link href="#" className="text-xs font-semibold text-[#C87A5E] hover:underline">Mot de passe oublié ?</Link></div>
                            <button type="submit" className="w-full bg-[#1f2937] text-white py-3 rounded-lg font-semibold text-sm hover:bg-[#C87A5E] transition-colors">Se Connecter</button>
                        </motion.form>
                    </motion.div>
                </motion.div>

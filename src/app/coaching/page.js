    ...
    return (
        <main>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        ...
                        <motion.div whileHover={{ scale: 1.03 }} className="relative z-[2] bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col">
                            ...
                            <div className="mt-auto p-8 pt-0">
                                <Link href="/compte/rendez-vous?type=coaching" className="block w-full text-center bg-[#1f2937] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#af4d30] transition-colors">
            ...
            {/* --- Section 5: Témoignages (Marquee) --- */}
             ...
             <FloatingCtaButton 
                href="/compte/rendez-vous?type=coaching"

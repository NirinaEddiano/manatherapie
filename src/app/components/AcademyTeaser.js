...
const AcademyTeaser = () => (
    <section className="py-24 bg-[#FFF7ED]">
        ...
        <div className="relative overflow-hidden">
            ...
            <div className="marquee-container-coaching">
                <div className="marquee-track-coaching" style={{ animationDuration: '60s' }}>
                    {[...bestSellers, ...bestSellers].map((course, i) => (
                        <Link href={`/academie/${course.slug}`} key={i} className="flex-shrink-0 w-80 mx-4 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-500 group">
                            <div className="relative h-48"><Image src={course.image} alt={course.title} fill className="object-cover rounded-t-2xl"/></div>
                            <div className="p-5 text-left">
                                <p className="text-sm text-[#C87A5E] font-semibold">{course.category}</p>
            ...
            <div className="text-center mt-12 mb-4">
                 <Link href="/academie" className="bg-[#C87A5E] text-white px-8 py-3 rounded-full font-semibold hover:bg-[#b56b50] transition-colors">
